...
{
    public partial class DropNonPayment : Window
    {
        private readonly IInHouseDataAccess _db;
        private readonly IUserSession _userSession;
        private readonly IGeneralDataPulls _codes;

        public DropNonPayment(IInHouseDataAccess db, IUserSession userSession, IGeneralDataPulls codes)
        {
            _db = db;
        ...
        private void UploadBtn_OnClick(object sender, RoutedEventArgs e)
        {
            ...
            var message = _db.ProcessDropList(parameters.FilePath, parameters.AcademicYear, parameters.AcademicTerm,
